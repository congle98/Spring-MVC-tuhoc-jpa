...
public class AppConfig implements WebMvcConfigurer, ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/jpa-uploadfile-quanlyhocsinh");
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addFormatter(new AddressFormatter(applicationContext.getBean(AddressService.class)));
